...
namespace Assets.Scripts
{
    class Slicer
    {
        ...
        /// <returns></returns>
        public static GameObject[] Slice(Plane plane, GameObject objectToCut, GameObject parenter)
        {            
            ...
            positiveObject.AddComponent<Draggin2>();
            negativeObject.AddComponent<Draggin2>();
            positiveObject.AddComponent<CookAny>();
            negativeObject.AddComponent<CookAny>();
            positiveObject.GetComponent<Rigidbody>().constraints = RigidbodyConstraints.FreezePositionX;
            negativeObject.GetComponent<Rigidbody>().constraints = RigidbodyConstraints.FreezePositionX;
            positiveObject.layer = 3;
            negativeObject.layer = 3;
            positiveObject.transform.parent = parenter.transform;
            negativeObject.transform.parent = parenter.transform;
